...
struct Profile {
  ...
  Matrix to_column(const Matrix &color) {
    return Matrix({{color(0, 1)}, {color(0, 2)}, {color(0, 3)}});
  }
};
...
const static std::vector<Profile> profiles = {
    {"srgb", Matrix({{0.6400f}, {0.3300f}, {0.212656f}}),
     ...
     Matrix({{0.95047f}, {1.00000f}, {1.08883f}})},
    ...
    {"cie_rgb", Matrix({{0.7350f}, {0.2650f}, {0.176204f}}),
     ...
     Matrix({{1.00000f}, {1.00000f}, {1.00000f}})},  // Illuminant E
    ...
    {"ntsc_rgb", Matrix({{0.6700f}, {0.3300f}, {0.298839f}}),
     ...
     Matrix({{0.98074f}, {1.00000f}, {1.18232f}})},  // Illuminant C
